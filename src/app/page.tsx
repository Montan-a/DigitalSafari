...
const perks = [
...

  {
    ...
    description:
      "All assets are assessed by our team to ensure they meet our high standards",
  },

  {
    ...
    Icon: Leaf,
    description:
      "We've pledged 1% of all sales to vaurious wildlife santuaries",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to DigitalSafari. Every assest on our platform is verified
