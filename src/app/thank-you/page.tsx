        ...
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            <p className="mt-2 text-base text-muted-foreground">
              Your order was prossessed and your assets are available to
              download below. We&apso;ve sent your receipt and order details to{" "}
            ...
            <p className="mt-2 text-base text-muted-foreground">
              We appreciate your order, and we&apso;re currently processing it.
              We&apso;ll send you a confirmation email soon.
            </p>
          )}
          ...
          <div
            className="mt-16 border-t
                   border-gray-200 py-6 text-right"
          >
            <Link
              href="/products"
